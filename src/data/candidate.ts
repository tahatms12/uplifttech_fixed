...
// 🧠 Utility: quick tokenizer for searching
...
export const CANDIDATES: Candidate[] = [
  {
    ...
    salaryRangePKR: { min: 150000, max: 200000 },
    languages: ['English B2', 'Urdu Native'],
    education: [
      { degree: 'MSc Mathematics', institution: 'University of Punjab', year: 2021 },
      { degree: 'BA', institution: 'University of Punjab', year: 2017 },
    ],
    experience: [
      {
  ...
  },
  {
    ...
    salaryRangePKR: { min: 80000, max: 120000 },
    languages: ['English B2', 'Urdu Native'],
    education: [
      {
  ...
  },
  {
    ...
    salaryRangePKR: { min: 200000, max: 280000 },
    languages: ['English B2', 'Urdu Native'],
    education: [
      { degree: 'English (Graduation)', institution: 'University of the Punjab', year: null },
    ],
    experience: [
      {
  ...
  },
  {
    ...
    salaryRangePKR: { min: 250000, max: 350000 },
    languages: ['English C2', 'Urdu Native'],
    education: [
      { degree: 'MSc Public Health', institution: 'Aga Khan University', year: 'Present' },
      { degree: 'BDS', institution: 'Dow University of Health Sciences', year: 2021 },
    ],
    experience: [
      {
  ...
  },
  {
    ...
    languages: ['English B2', 'Urdu Native'],
    education: [
      { degree: 'BBA Hons', institution: 'National University of Modern Languages (NUML)', year: 2025 },
    ],
    experience: [
      {
        company: 'Comtanix',
        ...
        highlights: ['Business process outsourcing', 'Inside sales', 'Client development'],
      },
      {
        company: 'Askari Bank',
        role: 'Intern',
        ...
        highlights: ['6-week internship in banking operations', 'File management and task coordination'],
      },
      {
        ...
        highlights: ['Final expense programs', 'Insurance companies', 'Customer service'],
      },
    ],
    videoUrl: '',
  ...
  },
  {
    ...
    timezone: 'UTC+5',
    availabilityLeadTime: '1 month',
    salaryRangePKR: { min: 100000, max: 140000 },
    ...
    education: [
      ...
      { degree: 'Project Management Certificate', institution: 'Coursera', year: null },
      {
  ...
  },
  {
    ...
    timezone: 'UTC+5',
    availabilityLeadTime: '2 weeks',
    salaryRangePKR: { min: 140000, max: 180000 },
    languages: ['English B2', 'Urdu Native'],
    education: [
      { degree: 'MBA', institution: 'Iqra University', year: 2025 },
      { degree: 'BBA', institution: 'Iqra University', year: 2023 },
    ],
    experience: [
      {
  ...
  },
  {
    ...
    timezone: 'UTC+5',
    availabilityLeadTime: 'Immediate',
    salaryRangePKR: { min: 50000, max: 70000 },
    languages: ['English B2', 'Urdu Native'],
    education: [
      { degree: 'BS Psychology', institution: 'The Woman University of Multan', year: 2025 },
      { degree: 'Medical Billing Training', institution: 'Profit Diaries', year: 2025 },
    ],
    experience: [],
    videoUrl: '',
...
// 🧩 Add tokenized strings for searching
CANDIDATES.forEach((c) => {
  ...
  c._tokens = tokenize(allText).join(' ');
});
